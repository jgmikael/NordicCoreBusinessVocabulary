...
**Synonyms (altLabels):** None

**Note:** EU Core Business Vocabulary definition for "Legal entity activity" =  The area of work in which the Legal Entity is engaged.
...
**Note:** The term agent represents an upper class / broader concept that would encompass both natural persons, sole traders, organizations, registered organizations, legal entities and others that are capable of actions like "doing business.
...
**Note:** Need to decide whether to devite from EU core for translated versions of legal name or to create a seperate category
...
**Note:** The question whether a natural person actually &quot;owns&quot; or &quot;controls&quot; the agent is decided separately in each national jurisdiction. It is also dependent on the legal form of the agent. <br />Based on Directive (EU) 2015/849 Artcicle 3, section 6
...
**Synonyms (altLabels):** business, enterprise
...
**Note:** Delegable means that something is able to be assigned or transferred to another agent, typically referring to duties, powers, or responsibilities.
...
**Synonyms (altLabels):** board substitute?
...
**Note:** An economic activity is characterised by an input of resources (such as capital goods, labour, manufacturing techniques or intermediary products), a production process and an output of products (goods or services).  <br />Economic activity does not have to be carried out for profit or even regularly. When economic activities are carried out by agents in order to generate profit, the economic activity can be described as business activity. <br />Economic activity values should be expressed as values from a common codelist. In the NSG&amp;B context the values should be taken from NACE.
...
**Synonyms (altLabels):** Vergar tekjur
...
**Note:** In the context of business related information, the main identifier for a business entity is usually the "legal identifier", which is the identifier given to the business entity when it is registered by a competent authority in a specific jurisdiction.
...
**Note:** Definition taken from Core Person Vocabulary 2.1.1
...
**Note:** A legal entity is a company, business, sole trader, non-profit association or similar entity that is registered with a business registration authority or other public authority.; Reason for a definition that is different from the EU Core Business Vocabulary:
1. EU Core definition of legal entity does not reference to the definition of formal organization
2. The EU Core definition of legal entity uses trade which is too narrow as it excludes for example manufacturing.
...
**Note:** Reason for a definition that is different from the EU Core Business Vocabulary: 
EU Core Business Vocabulary is using "Legal form type" = The classification of the Legal Entity as a member of a particular group in the context of legal registration.
1. We are defining the concept legal form
...
**Note:** EU Core Business Vocabulary definition for "legal identifier" = The unambiguous structured reference assigned to the Legal Entity by the legal authority that registered it.
...
**Note:** The legal name is often the official name to be used in legal context; Reason for a definition that is different from the EU Core Business Vocabulary:
"The name under which the Legal Entity is legally registered."
1. A legal entity can not be illegally registered
...
**Synonyms (altLabels):** status

**Note:** The nationally registered legal status of the agent. In the context of this model, the national values for legal status are mapped to the codes: * NONE - no extraordinary circumstances registered. The registration authority does not have anything registered but note that this doesn&#039;t say anything about for example financial status of the agent at this point in time. * SOME - some extraordinary circumstances registered. The registration authority have registered information on for example thet bankruptcy proceedings have started. To know the exact nationally registered legal status you need to check that national register. * ENDED - The registration authority have registered information on for example bankruptcy. The legal entity is no longer able to do buiness.; Reason for a definition that is different from the EU Core Business Vocabulary:
...
1. The registration authority might not have the full picture about the viability of the current postion of the legal entity.
1.
...
**Synonyms (altLabels):** proxy, power of attorney, representation, delegation of authority, authorization
...
**Synonyms (altLabels):** authorized party, proxy holder, delegate, representative, agent
...
**Synonyms (altLabels):** principal, grantor, authorizer, delegator, assignor

**Note:** Agent refers to either a person or a legal entity.  The authority to act on the other agents behalf is typically created through a formal agreement or legal instrument.
...
**Note:** EU Core Business Vocabulary definition for "legal name" = The name under which the Legal Entity is legally registered.
...
**Note:** Danish Financial Statements Act: bilag 2 årsregnskabsloven, Skema 3; Accounting regulation 1 Chapter 1 Section
Accounting Act Chapter 4 Section 1; Årsredovisningslag  
ÅRL 1995:1554 Bilaga 2; Chapter 6. Section 6-1. Item 1.; 23. tölul. 2. gr. laga nr. 3/2006.
Categories of undertakings: 11. tölul. 2. gr. laga nr. 3/2006
Income statement: 1. tölul. 5. gr. reglugerðar nr. 696/2019
...
**Note:** This term is taken from EU Core Business Vocabulary 2.1.0
...
**Synonyms (altLabels):** organization

**Note:** Represents a collection of people organized together into a community or other social, commercial or political structure. The group has some common purpose or reason for existence which goes beyond the set of people belonging to it and can act as an agent. Organizations are often decomposable into hierarchical structures.
...
**Note:** Accounting regulation 1 Chapter 1 Section

Liiketoiminnan muu tuottoerää on tulkittava varsin laajasti. Siihen luetaan kaikki sellaiset tuottoerät joilla on yhteyttä kirjanpitovelvollisen suoritetuotantoon kuulumatta kuitenkaan siihen. Tämän laatuiseksi yrityksen suoritetuotantoon liittyväksi toiminnaksi katsotaan myös käyttöomaisuuden myynnistä saadut tuotot. Kirjanpitolainsäädännön uudistamiskomitean mietintö: Liiketoiminnan muihin tuottoihin liittyvät yleensä myös pysyvien vastaavien myynnistä saadut tuotot. (KILA 1994/1254)
...
**Synonyms (altLabels):** natural person

**Note:** Taken from EU Core Business Vocabulary
...
**Note:** Postal addresses are usually formed according to a specific postal addressing system, which tends to be nationally specified and unique.
...
**Synonyms (altLabels):** legal address

**Note:** The registered address is the address, where the legal entity or his or her representative is available for official matters. Most often this is the address of the main office, head office, registered office or headquarters of the agent.  For most companies the registered address is also the default address but an agent can also declare a specific postal address separately.

EU Core Business Vocabulary definition for "registered address" = The address at which the Legal Entity is legally registered.
...
**Synonyms (altLabels):** date of registration

**Note:**  If a register issues an identifier the registration date will also be the date of issuing this identifier.
...
**Note:** Other versions:
criterion for the mandate that gives power to an agent to represent a legal entity
criterion for power to one or several agents to represent a legal entity
The capacity to act on behalf.. is from here https://everis-rpam.github.io/Glossary.html#C
...
**Note:** A representation rule can express that a person in a certain position in a company (agent) can represent the company alone or jointly together with others or simply state that a specific person has been granted this right without being previously affiliated to the company (agent).
...
**Note:** A role usually comes with specific legal, administrative, or decision-making rights and responsibilities.
...
**Note:** Legal entity is useb by ISA2 but we haven&#039;t defined it, should we do that?
